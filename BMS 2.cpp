...
class BankAccount{
  ...
  void show_menu(){
    ...
    do{cout<<"Your AccountNumber: "<<acc+customerId<<endl;
      cout<<"A. Show Details"<<endl;
      cout<<"B. Check Balance"<<endl;
      cout<<"C. Deposit"<<endl;
      cout<<"D. Withdraw"<<endl;
      cout<<"E. Previous Transaction"<<endl;
      cout<<"F. Update Details"<<endl;
      cout<<"G. Create Account"<<endl;
      cout<<"H. Exit"<<endl;
